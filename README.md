...
if [ -f $CACTUS_PREPARE_FILE ] && [ -d $WORKDIR/0 ]; then
    ...
    # commands generated by cactus-prepare to the script
...
awk '/cactus-blast/{
    ...
    # double quotes for awk, and escape double quotes inside the command
...
/hal2fasta/ {
    ...
    # Add the hal2fasta command to the same file
    print >> filename;
}
' /path/to/dir/cactus_prepare_21families.txt
```
